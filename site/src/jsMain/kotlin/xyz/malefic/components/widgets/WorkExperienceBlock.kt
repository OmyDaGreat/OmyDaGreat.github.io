...
@Composable
fun WorkExperienceBlock(modifier: Modifier = Modifier, workExperience: WorkExperience) {
  Box(
    ...
    Column(
      ...
      SpanText(
        ...
        modifier =
          WorkExperienceItemRoleAndDurationStyle.toModifier()
            .fillMaxWidth()
            .color(
              when (ColorMode.current) {
                ColorMode.LIGHT -> Colors.Gray
      ...
      SpanText(
        ...
        modifier =
          WorkExperienceItemOrgStyle.toModifier()
            .fillMaxWidth()
            .color(
              when (ColorMode.current) {
