 ...
 */
class SitePalette(val nearBackground: Color, val cobweb: Color, val brand: Brand) {
  class Brand(val primary: Color = Color.rgb(0x3C83EF), val accent: Color = Color.rgb(0xF3DB5B))
}
