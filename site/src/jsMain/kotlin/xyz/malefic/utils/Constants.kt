...
object Constants {
    const val RESUME_URL = "https://www.canva.com/design/DAE_weT2nG4/WCh6LLhrXqmIHtZF2spGFg/view?utm_content=DAE_weT2nG4&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=he3f15269ab"
    ...
    const val AND_NICE_TO_MEET_YOU = "and it's nice to meet you!"
    const val RESUME = "Resume"

    const val ABOUT_ME_TEXT = "I am a versatile software developer proficient in desktop and mobile development. I have a strong foundation in software development, and I am always eager to learn new technologies. I am a quick learner and a team player who is passionate about software development and always ready to take on new challenges."
    ...
    const val PROJECT_REPOSITORIES_URL = "https://github.com/OmyDaGreat?tab=repositories"
